...
/// [`Role::User`] or [`Role::Assistant`] — Anthropic's Messages API keeps system
...
/// A conversational template for Anthropic's Messages API: optional system
/// instructions plus a list of user/assistant message templates.
///
/// # Example
///
/// ```
/// use llm_chain_anthropic::messages::{ChatPromptTemplate, Role};
///
...
/// ```
/// use llm_chain_anthropic::messages::ChatPromptTemplate;
